...
to set-parameters
  ...
  set start-inventory (map [[a] -> a / 4] max-inventory)
...
to redistribute
  let zakat (map [[a b] -> max (list 0 (a - b))] inventory max-inventory)
...
show-agent-color
show-agent-color
"family" "charm" "satisfaction" "production" "consumption" "inventory" "net-trade" "trade-volume" "traded-item" "prices" "genome" "age" "num-child" "trade-will" "reproduce?" "k-means"
3
