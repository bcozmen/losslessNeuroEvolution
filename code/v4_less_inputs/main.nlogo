...
to set-parameters
  ...
  set start-inventory (map [[a] -> 2] max-inventory)
...
to go
  ...
  tick
  if true and (ticks mod 100 = 0)[
   if nutrition-multiplyer > 2.5 [
      set nutrition-multiplyer (nutrition-multiplyer - 0.1)
      read-files
...
show-agent-color
show-agent-color
"family" "charm" "activation" "satisfaction" "production" "consumption" "inventory" "net-trade" "trade-volume" "traded-item" "trade-wish-buy" "trade-wish-sell" "prices" "genome" "utility" "age" "num-child" "trade-will" "want-reproduce?" "reproduce?" "k-means"
9
